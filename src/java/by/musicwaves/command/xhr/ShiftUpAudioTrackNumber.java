...
/**
 * This XHRProcessor is designed to shift up single audio track number (in album) <br><br>
 * Access restrictions: ADMINISTRATOR and CURATOR level users only
 */
public class ShiftUpAudioTrackNumber implements XHRProcessor
{
    ...
    {
        LOGGER.debug("SHIFT UP TRACK NUMBER command reached");
        ...
        try
        {
            ...
            {
                dao.shiftTrackNumberUp(trackId);
            ...
            {
                LOGGER.error("SHIFT UP TRACK NUMBER command, error occured", ex);
