...
/**
 * This XHRProcessor is designed to search albums using passed search string value. 
 * Found albums + bound artists data will be returned as JSON-object to the requesting side. <br><br>
 ...
 */
public class MusicSearchGetFoundAlbumsListCommand implements XHRProcessor
{
    ...
    {
        LOGGER.debug("Music Search: get found albums command reached");
        ...
        try
        {
            ...
            {
                List<List<Map<String, String>>> searchResult = dao.processMusicSearchFindAlbums("%" + searchString + "%", user.getId(), limit, offset);
                ...
                parseFoundAlbums(json, searchResult.get(1));
    ...
    private void parseFoundAlbums(JsonSelfWrapper json, List<Map<String, String>> rows) throws CommandException
    {
