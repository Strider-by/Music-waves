...
public class AlbumImageLoader
{
    ...
    private final static String ALBUMS_IMAGES_SUBDIR = "images" + File.separator + "albums" + File.separator;
    ...
    public String upload(HttpServletRequest request, int albumId)
    {
        File fileFromRequest = getFileFromRequest(request, generateFileName(albumId));
    ...
    private File getFileFromRequest(HttpServletRequest request, String fileName)
    {
        try
        {
            ...
            String uploadDirPath = STATIC_DATA_DIRECTORY + File.separator + ALBUMS_IMAGES_SUBDIR;
        ...
        {
            LOGGER.error("Album image loader, error occured", ex);
            return null;
        }
    }
    ...
    {
        File oldFile = new File(STATIC_DATA_DIRECTORY + File.separator + ALBUMS_IMAGES_SUBDIR + fileName);
