...
public class ArtistImageLoader
{
    ...
    private final static String ARTISTS_IMAGES_SUBDIR = "images" + File.separator + "artists" + File.separator;
    ...
    public String upload(HttpServletRequest request, int artistId)
    {
        File fileFromRequest = getFileFromRequest(request, genFileName(artistId));
    ...
    private File getFileFromRequest(HttpServletRequest request, String fileName)
    {
        try
        {
            ...
            String uploadDirPath = STATIC_DATA_DIRECTORY + File.separator + ARTISTS_IMAGES_SUBDIR;
        ...
        {
            LOGGER.error("Artist image loader, error occured", ex);
            return null;
        }
    }
    ...
    public void deleteImageFile(String fileName)
    {
        ...
        File oldFile = new File(STATIC_DATA_DIRECTORY + File.separator + ARTISTS_IMAGES_SUBDIR + fileName);
    ...
    private String genFileName(int id)
    {
